                ...
                <div class="row align-items-center">
                    <header class="col-12 m-auto bg-white text-center pt-5">
                            <h1 id="mainTitle" class="display-4">Faltas de asistencia</h1>
                            <p id="mainTitle" class="text-left pt-5">Resumen general</p>
                    </header>
                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6 card">
                                    ...
                                    <div class="row h-50">
                                        ...
                                        <div class="col-6">
                                            <div class="circulo circuloExtraGrande mt-4">
                                                <img src="https://picsum.photos/200/200?image=24" alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="col-6 card">
                                    ...
                                    <div class="row h-50">
                                        ...
                                        <div class="col-6">
                                            <div class="circulo circuloExtraGrande mt-4">
                                                <img src="https://picsum.photos/200/200?image=26" alt="">
                                            </div>
                                        </div>
